...
import trelloLogo from "@/public/Trello_logo.png";
    ...
    <header>
      ...
      >
        ...
        <div className="flex items-center space-x-5 flex-1 justify-end w-full">
          ...
          {/* Avator */}
          <Avatar name="Osama malik" round size="50" color="#0055D1" />
        </div>
      </div>
      <div className="flex items-center justify-center px-5 py-2 md:py-5">
        <p
          className="flex items-center text-sm font-light p-5 pr-5 shadow-xl 
